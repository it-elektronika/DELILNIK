...
private:
  ...
  #define SPI_ETHERNET_SETTINGS SPISettings(4000000, MSBFIRST, SPI_MODE0)
		...
		#if defined(__AVR_ATmega1280__) // INDUSTRIAL SHIELDS. COMMENT || defined(__    AVR_ATmega2560__)
	    inline static void initSS()    { DDRB  |=  _BV(4); };
      inline static void setSS()     { PORTB &= ~_BV(4); };
      inline static void resetSS()   { PORTB |=  _BV(4); };
    // INDUSTRIAL SHIELDS. ADD
    #elif defined(__AVR_ATmega2560__) 
      inline static void initSS()    { digitalWrite(53, HIGH); };
      inline static void setSS()     { digitalWrite(53, LOW); };
      inline static void resetSS()   { digitalWrite(53, HIGH); };
/*
